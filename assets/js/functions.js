...
//Comienza --- Imprimir factura
function imprimir_factura(objet) { //funcion de redireccion de articulos
...
$('#myBody').on('click', "[id^='impresion__Categoria']", function(e) {
    e.preventDefault();
    let cat_id = $(this).attr('data-cat_id');
    //console.log('esto es'+ cat_id);
    imprimirArt_categoria(cat_id);
});
//termina --- Imprimir los articulos segun la categoria

//Comienza --- Imprimir articulo seleccionado
function imprimirArt_seleccionado(objet) { //funcion de redireccion de articulos
...
$('#myBody').on('click', "[id^='btn_imprimirArt']", function(e) {
    e.preventDefault();
    let art_id = $(this).attr('data-art_id');
    console.log(art_id);
    imprimirArt_seleccionado(art_id);
});
//termina --- Imprimir articulo seleccionado
