...
<body>
    ...
    <form class="BalanceCalculator">
        <!--Titulo -->
        <p class="BalanceCalculator_Title">Calculo de Finanzas</p>
        <!--Balance-->
    ...
    <div class="container-fluid col-lg-6 col-sm-6 table-responsive mt-2" style="max-height: 300px; overflow-y: auto;">
